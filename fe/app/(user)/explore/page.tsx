...
export default function ExploreFeedPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col gap-12 max-w-7xl mx-auto px-2">
        {/* Header Section */}
        <div className="flex flex-col gap-3 py-5 border-b border-[#ffedd5]/60">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between border-b border-[#ffedd5]/60 pb-3">
  ...
  if (error) {
    return (
      <div className="flex flex-col gap-12 max-w-7xl mx-auto px-2 py-10">
        <div className="flex flex-col items-center justify-center py-20 text-center gap-4 bg-[#ffedd5] border border-[#fdba74] rounded-3xl">
          <p className="text-xl font-bold text-[#c2410c]">Failed to load recommendations</p>
  ...
  if (!hasHighlights) {
    return (
      <div className="flex flex-col gap-12 max-w-7xl mx-auto px-2 py-10">
        <div className="flex flex-col items-center justify-center py-20 text-center gap-4 bg-[#fcfbfa] border border-[#fdba744d] rounded-3xl">
          <FiCompassIcon className="text-4xl text-[#fdba74]" />
          <p className="text-lg font-bold text-[#f97316]">No recommendations found</p>
  ...
  return (
    <div className="flex flex-col gap-12 max-w-7xl mx-auto px-2">
      {/* 1. Header Section */}
      <div className="flex flex-col gap-3 py-5 border-b border-[#ffedd5]/60">
        <h1 className="text-3xl md:text-4xl font-extrabold text-[#f97316] tracking-tight font-sans">
          Discover Missions
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {hotQuest ? (
          ...
          >
            ...
            <Card.Header className="flex flex-row items-center justify-between z-10 p-0 mb-6">
              <Chip color="danger" variant="soft" className="bg-[#ffffff] border border-[#ffedd5] text-[#f97316] rounded-full px-3 py-1 flex items-center gap-1.5">
                <FaFire size={12} className="text-[#f97316] animate-bounce" />
            ...
            <Card.Content className="flex flex-col gap-4 z-10 p-0 mb-6">
              <h2 className="text-2xl font-bold text-[#f97316] tracking-tight">
                {hotQuest.title}
              </h2>
            ...
            <Card.Footer className="flex flex-row items-center justify-between z-10 p-0 border-t border-[#f8f4ef] pt-5">
              <Link href={`/quests/${hotQuest.uuid}`}>
                <Button className="bg-[#f97316] text-white hover:bg-[#c2410c] transition-all text-xs font-bold px-6 py-2.5 rounded-full shadow-sm">
                  Start Mission
                </Button>
              </Link>
              
              <div className="flex items-center gap-1.5 text-xs font-bold text-[#f97316] bg-[#f3efff] px-3 py-1.5 rounded-full border border-[#e5dcff]">
                <SolanaIcon size={14} />
        ...
        {featuredProvider ? (
          ...
          >
            <div className="absolute -right-8 -top-8 w-24 h-24 bg-[#ffedd5] rounded-full opacity-40 blur-xl pointer-events-none" />
            ...
            <Card.Content className="flex flex-col items-center gap-3 p-0 mb-6 text-center">
              <div className="w-20 h-20 bg-[#ffedd5] rounded-full border-4 border-white shadow-sm flex items-center justify-center overflow-hidden">
                {featuredProvider.logo_url ? (
                  ...
                  <div className="w-full h-full bg-[#ffedd5] flex items-center justify-center text-[#f97316] text-xl font-bold">
                    {featuredProvider.display_name.charAt(0).toUpperCase()}
                  </div>
                )}
              </div>
              
              <h4 className="text-lg font-bold text-[#f97316] tracking-tight">
                {featuredProvider.display_name}
              </h4>
              
              <div className="bg-[#ffffff] border border-[#ffedd5] rounded-full px-3 py-1 text-xs font-bold text-[#6b6560] tracking-wide">
            ...
            <Card.Footer className="p-0 flex justify-center w-full">
              <Link href={`/quests?provider=${encodeURIComponent(featuredProvider.display_name)}`} className="w-full">
                <Button 
                  variant="outline" 
                  className="w-full bg-white text-[#f97316] hover:bg-[#ffffff] border border-[#c9c1b6] hover:border-[#f97316] transition-all text-xs font-bold py-2.5 rounded-full shadow-sm"
                >
                  Explore Quests
                </Button>
              </Link>
      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between border-b border-[#ffedd5]/60 pb-3">
          <h2 className="text-xl md:text-2xl font-bold text-[#f97316]">
            Top Providers
          </h2>
          <Link 
            href="/quests" 
            className="text-xs font-bold text-[#6b6560] hover:text-[#f97316] flex items-center gap-1 transition-colors uppercase tracking-wider"
          >
            View All Quests
            ...
            return (
              <Card key={provider.uuid} className="bg-white border border-[#f8f4ef] rounded-3xl p-6 flex flex-col justify-between hover:shadow-md transition-all duration-300">
                <Card.Header className="flex flex-row items-center justify-between p-0 mb-5">
                  <div className="flex items-center gap-3">
                    {provider.logo_url ? (
                      <img
                        ...
                        className="w-10 h-10 rounded-full object-cover bg-[#f8f4ef] border border-[#ffedd5]/60"
                      />
                    ) : (
                      <div 
                  ...
                  <Chip className="bg-[#ffffff] border border-[#ffedd5] text-[#f97316] rounded-full text-[10px] font-bold px-2 py-0.5">
                    <Chip.Label>Featured</Chip.Label>
                  </Chip>
                </Card.Header>

                <Card.Content className="flex flex-col gap-2 p-0 mb-6">
                  <h3 className="text-base font-bold text-[#1f1b18] hover:text-[#f97316] transition-colors leading-snug">
                ...
                <Card.Footer className="flex items-center justify-between p-0 border-t border-[#f8f4ef] pt-4 mt-auto">
                  ...
                  <Link 
                    ...
                    className="text-xs font-bold text-[#f97316] hover:text-[#c2410c] flex items-center gap-1 transition-colors group"
                  >
                    Explore
