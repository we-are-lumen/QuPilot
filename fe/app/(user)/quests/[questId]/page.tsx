  ...
  return (
    <div className="flex items-center gap-2.5 bg-white border border-[#e8e0d8] rounded-xl px-3 py-2.5 min-w-0 flex-1">
      {logoUri && !imgError ? (
        ...
        <div className="w-8 h-8 rounded-full bg-[#c2410c1a] flex items-center justify-center shrink-0 text-[#f97316] font-extrabold text-sm select-none">
...
export default function UserQuestDetailPage() {
  ...
  if (error || !quest) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center gap-4 bg-[#ffedd5] border border-[#fdba74] rounded-2xl mx-auto my-10 p-10">
        <p className="text-lg font-bold text-[#c2410c]">Failed to load quest</p>
        ...
        <Link
          href="/quests"
          className="text-body-sm text-[#f97316] hover:underline flex items-center gap-1.5 font-bold uppercase tracking-wider mt-4"
        >
    ...
    <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col gap-4 w-full">
        <div>
          <Link
            href="/quests"
            className="text-body-sm text-[#6b6560] hover:text-[#f97316] transition-colors flex items-center gap-1.5 font-bold uppercase tracking-wider"
          >
            <FiArrowLeft className="w-4 h-4" /> Back to Quests
          </Link>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
          <div className="flex flex-col gap-2 grow">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-3 py-1 rounded-full text-label font-bold bg-[#c2410c1a] text-[#f97316] capitalize">
                {quest.protocol} Protocol
              </span>
              <span className="px-3 py-1 rounded-full text-label font-bold bg-[#ffedd5] text-[#6b6560] flex items-center gap-1.5">
          ...
          {quest.quest_pool_pda ? (
            <div className="flex items-center gap-2 bg-white border border-[#f8f4ef] rounded-full px-4 py-2 self-start md:self-auto shadow-soft">
              ...
              <a
                ...
                className="text-mono text-[#f97316] hover:underline font-bold flex items-center gap-1.5"
              >
            ...
            <div className="flex items-center gap-2 bg-white border border-[#f8f4ef] rounded-full px-4 py-2 self-start md:self-auto shadow-soft">
              ...
              <Button
                ...
                variant="tertiary"
                className="w-8 h-8 rounded-full bg-[#f8f4ef] hover:bg-[#ffedd5] transition-all flex items-center justify-center p-0"
                aria-label="Copy Quest ID"
              >
                {copiedId ? (
                  <FiCheck className="w-4 h-4 text-[#10B981]" />
                ) : (
                  <FiCopy className="w-4 h-4 text-[#f97316]" />
                )}
              </Button>
            </div>
          )}
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <Card className="bg-white border border-[#f8f4ef] rounded-xl p-8 shadow-soft">
            <Card.Header className="flex items-center gap-2.5 p-0 mb-6 border-b border-[#f8f4ef] pb-4">
              <FiBookOpen className="w-6 h-6 text-[#f97316]" />
          ...
          <Card className="bg-white border border-[#f8f4ef] rounded-xl p-8 shadow-soft">
            <Card.Header className="flex items-center gap-2.5 p-0 mb-6 border-b border-[#f8f4ef] pb-4">
              <FiCpu className="w-6 h-6 text-[#f97316]" />
              <Card.Title className="text-h2 text-[#1f1b18] font-bold">
                      ...
                      return (
                        <div key={step.uuid} className="flex gap-3">
                          ...
                          <div className="flex flex-col items-center">
                            <div className="w-7 h-7 rounded-full bg-[#f8f4ef] border-2 border-[#f97316] flex items-center justify-center shrink-0 z-10">
                              <span className="text-[#f97316] text-[10px] font-extrabold">{step.order_index + 1}</span>
                            </div>
                              ...
                              if (step.step_type === "swap" && (p.from_token_symbol || p.to_token_symbol)) {
                                return (
                                  <div className="bg-[#f8f4ef] border border-[#e8e0d8] rounded-lg p-3 flex items-center gap-2">
                                    ...
                                    <FiRepeat className="text-[#f97316] text-lg shrink-0" />
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="bg-white border border-[#f8f4ef] rounded-xl p-8 shadow-soft">
            ...
            <Card.Content className="p-0 flex flex-col gap-4">
              ...
              {/* Secondary Reward */}
              <div className="flex items-center gap-4 bg-[#f8f4ef] rounded-2xl p-4">
                <div className="w-12 h-12 bg-[#f973161a] rounded-full flex items-center justify-center text-[#f97316] shrink-0">
