...
colors:
  ...
  surface-tint: '#aa3622'
  on-primary: '#ffffff'
  primary-container: '#c84b35'
  on-primary-container: '#fffbff'
  inverse-primary: '#ffb4a5'
  on-secondary: '#ffffff'
  secondary-container: '#9d7eff'
  on-secondary-container: '#33008a'
  tertiary: '#006767'
  on-tertiary: '#ffffff'
  ...
  on-primary-fixed-variant: '#891e0c'
  secondary-fixed: '#e8ddff'
  secondary-fixed-dim: '#cebdff'
  on-secondary-fixed: '#20005e'
  on-secondary-fixed-variant: '#4f2aab'
  tertiary-fixed: '#85f4f4'
  tertiary-fixed-dim: '#67d8d7'
...
spacing:
  ...
  huge: 72px
animation:
  spring-base: cubic-bezier(0.34, 1.56, 0.64, 1)
