...
|----------------|------------------------|
| `swap`         | (recommended) `from_token`, `to_token` (base58 Solana mint). For SOL use wSOL mint `So11111111111111111111111111111111111111112`. Backward-compat: `from_mint`, `to_mint` and `from_token_symbol`, `to_token_symbol` |
